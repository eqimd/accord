...
var file_accord_proto_rawDesc = []byte{
	...
	0x02, 0x0a, 0x07, 0x52, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x12, 0x34, 0x0a, 0x09, 0x50, 0x72,
	0x65, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x12, 0x11, 0x2e, 0x50, 0x72, 0x65, 0x41, 0x63, 0x63,
	0x65, 0x70, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x12, 0x2e, 0x50, 0x72, 0x65,
	0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x2b, 0x0a, 0x06, 0x41, 0x63, 0x63, 0x65, 0x70, 0x74, 0x12, 0x0e, 0x2e, 0x41, 0x63, 0x63,
	0x65, 0x70, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x41, 0x63, 0x63,
	0x65, 0x70, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2b, 0x0a,
	...
	,
	...
	0x22, 0x00, 0x12, 0x22, 0x0a, 0x03, 0x50, 0x75, 0x74, 0x12, 0x0b, 0x2e, 0x50, 0x75, 0x74, 0x52,
	...
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x65, 0x71, 0x69, 0x6d, 0x64, 0x2f, 0x61,
	0x63, 0x63, 0x6f, 0x72, 0x64, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
...
var file_accord_proto_msgTypes = make([]protoimpl.MessageInfo, 27)
var file_accord_proto_goTypes = []any{
	...
	nil,                       // 22: ReadResponse.ReadsEntry
	nil,                       // 23: ApplyRequest.ResultEntry
	nil,                       // 24: SnapshotResponse.ResultEntry
	nil,                       // 25: PutRequest.ValsEntry
	nil,                       // 26: GetResponse.ResultEntry
}
var file_accord_proto_depIdxs = []int32{
	...
	22, // 13: ReadResponse.reads:type_name -> ReadResponse.ReadsEntry
	...
	23, // 17: ApplyRequest.result:type_name -> ApplyRequest.ResultEntry
	24, // 18: SnapshotResponse.result:type_name -> SnapshotResponse.ResultEntry
	25, // 19: PutRequest.vals:type_name -> PutRequest.ValsEntry
	26, // 20: GetResponse.result:type_name -> GetResponse.ResultEntry
	2,  // 21: Replica.PreAccept:input_type -> PreAcceptRequest
	4,  // 22: Replica.Accept:input_type -> AcceptRequest
	6,  // 23: Replica.Commit:input_type -> CommitRequest
	8,  // 24: Replica.Read:input_type -> ReadRequest
	10, // 25: Replica.Apply:input_type -> ApplyRequest
	12, // 26: Replica.Pid:input_type -> PidRequest
	14, // 27: Replica.Snapshot:input_type -> SnapshotRequest
	16, // 28: Coordinator.Execute:input_type -> ExecuteRequest
	18, // 29: Coordinator.Put:input_type -> PutRequest
	20, // 30: Coordinator.Get:input_type -> GetRequest
	3,  // 31: Replica.PreAccept:output_type -> PreAcceptResponse
	5,  // 32: Replica.Accept:output_type -> AcceptResponse
	7,  // 33: Replica.Commit:output_type -> CommitResponse
	9,  // 34: Replica.Read:output_type -> ReadResponse
	11, // 35: Replica.Apply:output_type -> ApplyResponse
	13, // 36: Replica.Pid:output_type -> PidResponse
	15, // 37: Replica.Snapshot:output_type -> SnapshotResponse
	17, // 38: Coordinator.Execute:output_type -> ExecuteResponse
	19, // 39: Coordinator.Put:output_type -> PutResponse
	21, // 40: Coordinator.Get:output_type -> GetResponse
